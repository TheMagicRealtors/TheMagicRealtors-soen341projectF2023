...
<html>
        <head> 
            ...
            <script>
                 ...
                 window.location.href = 'book_visit.php?address=' + encodeURIComponent(address); //saves address and redorects to book_visit.php
                 }
...
<header>
                <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top" id="Mynavbar">
                    <div class="container-fluid">
                      <a class="navbar-brand" href="#" style="font-weight: bold; font-size: 35px;">The Magic Realtors</a>
                        ...
                        <li class="nav-item"><a class="nav-link" href="properties.php"> Properties</a>
                          ...
                          <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                              <li><a class="dropdown-item" href="#" style="text-align: center;">Log In</a></li>
