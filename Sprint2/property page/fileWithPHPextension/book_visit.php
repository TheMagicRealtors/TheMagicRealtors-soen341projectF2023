...
echo '<h4> Book a Visit to <b>' . $property['address'] . ', '. $property['district'] . ', ' . $property['city'] . '</b> now!</h4>';
...
echo '<div style="font: 95% Arial, Helvetica, sans-serif; padding: 16px;background: #F7F7F7;">
        <form method="post" action="processing_booking.php">
            ...
            <br><br>
            <textarea name="availabilities" id="availabilities" placeholder="Type your Availabilities" required></textarea>
