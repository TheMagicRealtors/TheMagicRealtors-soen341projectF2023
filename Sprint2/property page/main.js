        ...
        if (xhr.readyState === 4 && xhr.status === 200) {
            ...
            data.forEach(function (broker) {
                ...
                card.innerHTML = `
                    ...
                    <div class="card">
                        <img src="BrokerImages/broker_pic.png" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="card-title">${broker.broker_name}</h5>
                            <p class="card-text"><b>Personal Information:</b></p>
                            <p><img src="BrokerImages/email_broker.png" alt="Email Icon"> <span class="email">${broker.broker_email}</span></p>
                            <p><img src="BrokerImages/phone_broker.png" alt="Phone Icon"> <span class="phone">${broker.broker_phone}</span></p>
                            <p><img src="BrokerImages/address_broker.png" alt="Address Icon"> <span class="address">${broker.broker_address}</span></p>
